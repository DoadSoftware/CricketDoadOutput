...
public class Animation 
{
	...
	public String getTypeOfGraphicsOnScreen(Configuration config,String whatToProcess)
	{
		...
		case Constants.ICC_U19_2023:
			...
			case "Alt_w": case "Control_j": case "Alt_i": case "Alt_j": case "b": case "Control_i":
		...
		if(config.getPreview().equalsIgnoreCase("WITH_PREVIEW")) {
			...
			case Constants.ISPL:
				if(whichside == 1) {
					...
					case "Control_j": case "Alt_i": case "Alt_j":  case "b": case "Control_i":
					//case "n":	
