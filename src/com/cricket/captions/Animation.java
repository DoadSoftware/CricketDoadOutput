...
public class Animation 
{
	...
	public String getTypeOfGraphicsOnScreen(Configuration config,String whatToProcess)
	{
		...
		case Constants.NPL:
			...
			case "F8":
			case "Control_F5":	case "Alt_F8":
				
			case "F5": case "F6": case "F7":  case "F9": case "F10": case "F11": 
			case "Control_F9": case "Control_a":  case "Control_F3": case "Alt_o":
...
//				}
			...
			case "Control_d": case "Control_e": case "Shift_T": case "Shift_P": case "Shift_Q":
			...
			case "Control_F9":  case "Control_F3": case "Alt_o":
			...
			case "Shift_B":
			case "F10": case "j": case "Alt_a": case "Alt_s":
			case "Alt_Shift_F3":
				
			case "Control_F5": case "F8": case "Alt_F8":
...
//				this.tapeballOnScreen = "";
		...
		case Constants.NPL:
			...
			case "Alt_F8": case "F8": case "Control_F5":
				processAnimation(Constants.FRONT, print_writers, "Lower_Third$In_Out$Out$BASE", "START");
				processAnimation(Constants.FRONT, print_writers, "Lower_Third$In_Out$Out$LOGO", "START");
				processAnimation(Constants.FRONT, print_writers, "Lower_Third$In_Out$Out$HEADER", "START");
				processAnimation(Constants.FRONT, print_writers, "Lower_Third$In_Out$Out$BOTTOM_DATA", "START");
				
				switch (whatToProcess.split(",")[0]) {
				case "Control_F5":
					processAnimation(Constants.FRONT, print_writers, "Lower_Third$In_Out$Out$RIGHT_DATA", "START");
					break;
				}
				TimeUnit.MILLISECONDS.sleep(1000);
				AnimateIn(Constants.SHRUNK_INFOBAR + ",", print_writers, config); // Restore infobar
...
//						processAnimation(Constants.FRONT, print_writers, "Anim_Infobar$Change_RightInfo_BottomRightPart", "START");
			...
			case "Shift_T":	case "Control_d": case "Control_e": case "Shift_P": case "Shift_Q":
