...
public class Animation 
{
	...
	public String getTypeOfGraphicsOnScreen(Configuration config,String whatToProcess)
	{
		...
		case Constants.NPL:
			...
			case "F6": case "F10": case "Control_Shift_Q": case "Control_Shift_O": case "7":
...
//				this.tapeballOnScreen = "";
		...
		case Constants.NPL:
			...
			case "Control_Shift_M": case "Control_Shift_L":
				...
				break;
			case "Control_F3":
				System.out.println("this.isComp = " + this.isComp);
			...
			case "Control_Shift_O":
				...
				break;
			case "Control_Shift_U": case "Control_Shift_V":
				processAnimation(Constants.FRONT, print_writers, "PopUps$Out", "START");
				TimeUnit.MILLISECONDS.sleep(1000);
...
//				break;
			...
			case "z": case "x": case "c": case "v":
				...
				if(Integer.valueOf(whatToProcess.split(",")[2].split("_")[0]) > 0) {
					processAnimation(Constants.BACK, print_writers, "LeaderBoardHighlight$Side1$Player"+whatToProcess.split(",")[2].split("_")[0], "SHOW 1.782");
				}
		...
		if(config.getPreview().equalsIgnoreCase("WITH_PREVIEW")) {
			...
			case Constants.NPL:
				if(whichside == 1) {
					switch(whatToProcess.split(",")[0]) {
					case "Control_Shift_B":
						previewCommands = "Anim_Infobar$Push 0.500 Anim_Infobar$Small 0.820 LT_NextToBat$In_Out 1.420 LT_NextToBat$In_Out$In 1.140 LT_NextToBat$In_Out$In$BASE 1.040 LT_NextToBat$In_Out$In$LOGO 1.000"
					...
					if(whichside == 1) {
						...
						case ".": case "/": case "Shift_C": case "Control_Shift_R": case "Control_Shift_F3": case "Control_Shift_J": case "Alt_p": case "o": case "t":
						 ...
						 case "6":
							 ...
							 CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER PREVIEW SCENE*" + "/Default/Overlays" + " C:/Temp/Preview.tga "
										+ "PopUps$In 1.700 PopUps$Change_Sixes 1.360 PopUps$Change_Sixes$Hundreds 1.360 PopUps$Change_Sixes$Tens 1.020 "
										+ "PopUps$Change_Sixes$Units 0.780\0", print_writer);
							 break; 	 
						}
					}else {
						switch(whatToProcess.split(",")[0]) {
