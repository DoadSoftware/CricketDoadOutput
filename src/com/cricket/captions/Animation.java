...
public class Animation 
{
	...
	public String getTypeOfGraphicsOnScreen(Configuration config,String whatToProcess)
	{
		...
		case Constants.NPL:
			...
			case "Control_Shift_Y": case "Alt_m": case "Alt_n": case "Control_Shift_E": case "Control_Shift_F": case "Alt_Shift_W":
		...
		if(config.getPreview().equalsIgnoreCase("WITH_PREVIEW")) {
			...
			case Constants.NPL:
				if(whichside == 1) {
					...
					case "Control_Shift_Y": case "Control_Shift_E": case "Control_Shift_F": case "Alt_Shift_W":
