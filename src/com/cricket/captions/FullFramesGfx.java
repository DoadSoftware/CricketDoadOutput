...
public class FullFramesGfx 
{
	...
	public String populateFixturesAndResults(int WhichSide, String whatToProcess, MatchAllData matchAllData, int WhichInning) throws ParseException, JsonMappingException, JsonProcessingException, InterruptedException 
	{
		FixturesList.clear();
		...
		if(team == null) {
			return "populatePlayingXI: Team id [" + Integer.valueOf(whatToProcess.split(",")[2]) + "] from database is returning NULL";
		}
	...
	public String PopulatePartPerformerFF(int WhichSide, String whatToProcess, MatchAllData matchAllData, int WhichInning) throws ParseException, InterruptedException
	{
		inning = matchAllData.getMatch().getInning().stream().filter(inn -> inn.getInningNumber() == WhichInning).findAny().orElse(null);
		if(inning == null) {
			return "PopulateBatPerformerFF: current inning is NULL";
		...
		case Constants.NPL:
			...
			case "F1": 
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + whichside + "$BattingCard$" +
						"Select_NumberOfRows*FUNCTION*Grid*row_offset SET "+offset+"\0", print_writers);
				break;
			case "F4":
		...
		case Constants.NPL:
			...
			case "F1": case "F2": case "Shift_K":
				...
				case "F1": case "Shift_K":
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$Logo$Side" + WhichSide + "$Start_Logo$img_LogosShadow"
							+ "*TEXTURE*IMAGE SET "+Constants.NPL_LOGO_PATH+ inning.getBatting_team().getTeamBadge() +"\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$Logo$Side" + WhichSide +"$Start_Logo$noname$img_Logos"
							+ "*TEXTURE*IMAGE SET "+Constants.NPL_LOGO_PATH+ inning.getBatting_team().getTeamBadge() +"\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$Logo$Side" + WhichSide + "$Logo$img_LogosShadow"
							+ "*TEXTURE*IMAGE SET "+Constants.NPL_LOGO_PATH+ inning.getBatting_team().getTeamBadge() +"\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$Logo$Side" + WhichSide +"$Logo$noname$img_Logos"
							+ "*TEXTURE*IMAGE SET "+Constants.NPL_LOGO_PATH+ inning.getBatting_team().getTeamBadge() +"\0", print_writers);
					...
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$ExtraData$Side" + WhichSide + "$Logo$img_Badges"
							+ "*TEXTURE*IMAGE SET "+Constants.NPL_LOGO_PATH+ inning.getBatting_team().getTeamBadge()+"\0", print_writers);
					if(whatToProcess.equalsIgnoreCase("Shift_K")) {
			...
			case "Control_d": case "Control_e": case "Shift_P": case "Shift_Q":
				...
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$ExtraData$Side" + WhichSide + "$Logo$img_Badges"
						+ "*TEXTURE*IMAGE SET "+Constants.NPL_LOGO_PATH+ team.getTeamBadge()+"\0", print_writers);
			...
			case "Control_Shift_F1":
				...
				case "PERFORMER":
					...
					if(config.getPrimaryIpAddress().equalsIgnoreCase(Constants.LOCALHOST)) {
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$ExtraData$Side" + WhichSide + "$Performer$img_Player"
								+ "*TEXTURE*IMAGE SET "+Constants.NPL_LOCAL_PHOTO_PATH+ inning.getBatting_team().getTeamName4()+ "\\\\"+player.getPhoto()+CricketUtil.PNG_EXTENSION+"\0", print_writers);
					}else {
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$ExtraData$Side" + WhichSide + "$Performer$img_Player"
								+ "*TEXTURE*IMAGE SET "+"\\\\"+config.getPrimaryIpAddress()+Constants.NPL_PHOTO_PATH+ inning.getBatting_team().getTeamName4()+ "\\\\"+player.getPhoto()+CricketUtil.PNG_EXTENSION+"\0", print_writers);
					}
					if(player.getSurname() != null) {
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$ExtraData$Side" + WhichSide + "$Performer$txt_FirstName"
								+ "*GEOM*TEXT SET "+player.getFirstname()+"\0", print_writers);
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$ExtraData$Side" + WhichSide + "$Performer$txt_LastName"
								+ "*GEOM*TEXT SET "+player.getSurname()+"\0", print_writers);
					}else {
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$ExtraData$Side" + WhichSide + "$Performer$txt_FirstName"
								+ "*GEOM*TEXT SET "+player.getFull_name()+"\0", print_writers);
					...
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$ExtraData$Side" + WhichSide + "$Performer$txt_StatHead"
							+ "*GEOM*TEXT SET S/R \0", print_writers);
					
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$ExtraData$Side" + WhichSide + "$Performer$txt-StatValue"
				...
				case "PARTNERSHIP":
					...
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$ExtraData$Side" + WhichSide + "$Partnership$NameGrp$txt_Title1"
					...
					if(config.getPrimaryIpAddress().equalsIgnoreCase(Constants.LOCALHOST)) {
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$ExtraData$Side" + WhichSide + "$Partnership$img_Player1"
								+ "*TEXTURE*IMAGE SET "+Constants.NPL_LOCAL_PHOTO_PATH +inning.getBatting_team().getTeamName4()+"\\\\"+
						...
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$ExtraData$Side" + WhichSide + "$Partnership$img_Player1"
								+ "*TEXTURE*IMAGE SET "+ "\\\\" + config.getPrimaryIpAddress()+Constants.NPL_PHOTO_PATH +inning.getBatting_team().getTeamName4()+"\\\\"+
								inning.getPartnerships().get(inning.getPartnerships().size()-1).getFirstPlayer().getPhoto()+ CricketUtil.PNG_EXTENSION+"\0", print_writers); 
					}
					if(config.getPrimaryIpAddress().equalsIgnoreCase(Constants.LOCALHOST)) {
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$ExtraData$Side" + WhichSide + "$Partnership$img_Player2"
								+ "*TEXTURE*IMAGE SET "+Constants.NPL_LOCAL_PHOTO_PATH +inning.getBatting_team().getTeamName4()+"\\\\"+
			...
			case "Control_Shift_F2":
				...
				if(config.getPrimaryIpAddress().equalsIgnoreCase(Constants.LOCALHOST)) {
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$ExtraData$Side" + WhichSide + "$Performer$img_Player"
							+ "*TEXTURE*IMAGE SET "+Constants.NPL_LOCAL_PHOTO_PATH+ inning.getBowling_team().getTeamName4()+ "\\\\"+player.getPhoto()+CricketUtil.PNG_EXTENSION+"\0", print_writers);
				}else {
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$ExtraData$Side" + WhichSide + "$Performer$img_Player"
							+ "*TEXTURE*IMAGE SET "+"\\\\"+config.getPrimaryIpAddress()+Constants.NPL_PHOTO_PATH+ inning.getBowling_team().getTeamName4()+ "\\\\"+player.getPhoto()+CricketUtil.PNG_EXTENSION+"\0", print_writers);
				}
				if(player.getSurname() != null) {
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$ExtraData$Side" + WhichSide + "$Performer$txt_FirstName"
							+ "*GEOM*TEXT SET "+player.getFirstname()+"\0", print_writers);
				...
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$ExtraData$Side" + WhichSide + "$Performer$txt_StatHead"
						+ "*GEOM*TEXT SET ECON. \0", print_writers);
			...
			case "Control_F11": case "Shift_F11":
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$All$HeaderGrp$Side" + WhichSide + "$Header_Style2$txt_HeaderText1"
						+ "*GEOM*TEXT SET MATCH\0", print_writers);
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$All$HeaderGrp$Side" + WhichSide + "$Header_Style2$txt_HeaderText2"
				...
				case "Shift_F11":
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$SudheaderGrp$Side" + WhichSide + "$txt_SubHeadText2"
							+ "*GEOM*TEXT SET "+matchAllData.getSetup().getTournament() + " - " +(fixture.getMatchnumber()<10?"MATCH "+fixture.getMatchnumber() : fixture.getMatchfilename())+"\0", print_writers);
					
					break;
				}
				break;
			case "m":
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Ident$Main$HeaderGrp$txt_SubHead"
						+ "*GEOM*TEXT SET "+matchAllData.getSetup().getTournament()+" - "+matchAllData.getSetup().getMatchIdent()+"\0", print_writers);
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Ident$Main$TeamLogo1$img_BadgesShadow"
						+ "*TEXTURE*IMAGE SET "+Constants.NPL_LOGO_PATH+matchAllData.getSetup().getHomeTeam().getTeamBadge()+"\0", print_writers);
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Ident$Main$TeamLogo1$img_Badges"
						+ "*TEXTURE*IMAGE SET "+Constants.NPL_LOGO_PATH+matchAllData.getSetup().getHomeTeam().getTeamBadge()+"\0", print_writers);
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Ident$Main$TeamLogo2$img_BadgesShadow"
						+ "*TEXTURE*IMAGE SET "+Constants.NPL_LOGO_PATH+matchAllData.getSetup().getAwayTeam().getTeamBadge()+"\0", print_writers);
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Ident$Main$TeamLogo2$img_Badges"
						+ "*TEXTURE*IMAGE SET "+Constants.NPL_LOGO_PATH+matchAllData.getSetup().getAwayTeam().getTeamBadge()+"\0", print_writers);
				break;
			case "Control_m":
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Ident$Main$TeamLogo1$img_BadgesShadow"
						+ "*TEXTURE*IMAGE SET "+Constants.NPL_LOGO_PATH+fixture.getHome_Team().getTeamBadge()+"\0", print_writers);
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Ident$Main$TeamLogo1$img_Badges"
						+ "*TEXTURE*IMAGE SET "+Constants.NPL_LOGO_PATH+fixture.getHome_Team().getTeamBadge()+"\0", print_writers);
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Ident$Main$TeamLogo2$img_BadgesShadow"
			...
			case "Control_Shift_F4":
				Partnership part = inning.getPartnerships().stream().filter(p -> p.getPartnershipNumber() == FirstPlayerId).findAny().orElse(null);
				
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$ExtraData$Side" + WhichSide + "$Select_DataType"
						+ "*FUNCTION*Omo*vis_con SET 2\0", print_writers);
				
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$ExtraData$Side" + WhichSide + "$Partnership$NameGrp$txt_Title1"
						+ "*GEOM*TEXT SET "+CricketFunctions.ordinal(FirstPlayerId)+" WICKET"+"\0", print_writers); 
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$ExtraData$Side" + WhichSide + "$Partnership$NameGrp$txt_Title2"
						+ "*GEOM*TEXT SET PARTNERSHIP\0", print_writers);
				if(part.getPartnershipNumber() == inning.getPartnerships().size()) {
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$ExtraData$Side" + WhichSide + "$Partnership$StatsAll$txt_Runs"
							+ "*GEOM*TEXT SET "+part.getTotalRuns() + "*" + "\0", print_writers);
				}else {
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$ExtraData$Side" + WhichSide + "$Partnership$StatsAll$txt_Runs"
							+ "*GEOM*TEXT SET "+part.getTotalRuns() + "\0", print_writers);
				}
				...
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$ExtraData$Side" + WhichSide + "$Partnership$StatsAll$txt_Balls"
						+ "*GEOM*TEXT SET "+part.getTotalBalls()+"\0", print_writers);
				if(config.getPrimaryIpAddress().equalsIgnoreCase(Constants.LOCALHOST)) {
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$ExtraData$Side" + WhichSide + "$Partnership$img_Player1"
							+ "*TEXTURE*IMAGE SET "+Constants.NPL_LOCAL_PHOTO_PATH +inning.getBatting_team().getTeamName4()+"\\\\"+
							part.getFirstPlayer().getPhoto()+ CricketUtil.PNG_EXTENSION+"\0", print_writers);
				}else {
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$ExtraData$Side" + WhichSide + "$Partnership$img_Player1"
							+ "*TEXTURE*IMAGE SET "+ "\\\\" + config.getPrimaryIpAddress()+Constants.NPL_PHOTO_PATH +inning.getBatting_team().getTeamName4()+"\\\\"+
							part.getFirstPlayer().getPhoto()+ CricketUtil.PNG_EXTENSION+"\0", print_writers); 
				...
				if(config.getPrimaryIpAddress().equalsIgnoreCase(Constants.LOCALHOST)) {
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$ExtraData$Side" + WhichSide + "$Partnership$img_Player2"
							+ "*TEXTURE*IMAGE SET "+Constants.NPL_LOCAL_PHOTO_PATH +inning.getBatting_team().getTeamName4()+"\\\\"+
							part.getSecondPlayer().getPhoto()+ CricketUtil.PNG_EXTENSION+"\0", print_writers);
				}else {
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$ExtraData$Side" + WhichSide + "$Partnership$img_Player2"
							+ "*TEXTURE*IMAGE SET "+ "\\\\" + config.getPrimaryIpAddress()+Constants.NPL_PHOTO_PATH +inning.getBatting_team().getTeamName4()+"\\\\"+
							part.getSecondPlayer().getPhoto()+ CricketUtil.PNG_EXTENSION+"\0", print_writers); 
			...
			case "Shift_T":
				...
				if(team.getTeamId() == matchAllData.getSetup().getHomeTeamId()) {
					...
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$All$HeaderGrp$Side" + WhichSide + "$Header_Style2$txt_HeaderText1"
							+ "*GEOM*TEXT SET " + matchAllData.getSetup().getHomeTeam().getTeamName2() + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$All$HeaderGrp$Side" + WhichSide + "$Header_Style2$txt_HeaderText2"
							+ "*GEOM*TEXT SET " + matchAllData.getSetup().getHomeTeam().getTeamName3() + "\0", print_writers);
					...
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$All$HeaderGrp$Side" + WhichSide + "$Header_Style2$txt_HeaderText1"
							+ "*GEOM*TEXT SET " + matchAllData.getSetup().getAwayTeam().getTeamName2() + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$All$HeaderGrp$Side" + WhichSide + "$Header_Style2$txt_HeaderText2"
							+ "*GEOM*TEXT SET " + matchAllData.getSetup().getAwayTeam().getTeamName3() + "\0", print_writers);
				}
				break;
			case "Alt_z": case "Shift_F8":
				...
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$All$HeaderGrp$Side" + WhichSide + "$Header_Style2$txt_HeaderText1"
						+ "*GEOM*TEXT SET " + team.getTeamName2() + "\0", print_writers);
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$All$HeaderGrp$Side" + WhichSide + "$Header_Style2$txt_HeaderText2"
						+ "*GEOM*TEXT SET " + team.getTeamName3() + "\0", print_writers);
				switch (whatToProcess) {
				case "Alt_z":
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$SudheaderGrp$Side" + WhichSide + "$txt_SubHeadText2"
							+ "*GEOM*TEXT SET SQUAD\0", print_writers);
					break;
...
//					}
			...
			case "Alt_Shift_R":
				...
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$HeaderDataAll$Side" + WhichSide + "$TextGrp$Text_Out$"
						+ "txt_SubHeader*GEOM*TEXT SET " + "BPTL 2024 - FIXTURES AND RESULTS" + "\0", print_writers);
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$HeaderDataAll$Side" + WhichSide + 
						...
						if(boc.getPlayerId() == FirstPlayerId) {
							...
							if(config.getPrimaryIpAddress().equalsIgnoreCase(Constants.LOCALHOST)) {
								CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$Extra_Info$Side" + WhichSide + "$Highest_Scorer$"
									+ "ImageGrp$img_Player*TEXTURE*IMAGE SET " + Constants.BENGAL_LOCAL_PHOTO_PATH + inning.getBowling_team().getTeamName4() 
										+ "\\\\" + boc.getPlayer().getPhoto() + CricketUtil.PNG_EXTENSION + "\0", print_writers);
								CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$Extra_Info$Side" + WhichSide + "$Highest_Scorer$"
										+ "ImageGrp$img_PlayerShadow*TEXTURE*IMAGE SET " + Constants.BENGAL_LOCAL_PHOTO_PATH + inning.getBowling_team().getTeamName4() 
											+ "\\\\" + boc.getPlayer().getPhoto() + CricketUtil.PNG_EXTENSION + "\0", print_writers);
							}else {
...
//								}
								...
								CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$Extra_Info$Side" + WhichSide + "$Highest_Scorer$"
									+ "ImageGrp$img_Player*TEXTURE*IMAGE SET " + "\\\\" + config.getPrimaryIpAddress() + Constants.BENGAL_PHOTO_PATH + 
										inning.getBowling_team().getTeamName4() + "\\\\" + boc.getPlayer().getPhoto() + CricketUtil.PNG_EXTENSION + "\0", print_writers);
								CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$Extra_Info$Side" + WhichSide + "$Highest_Scorer$"
...
//				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Squad$txt_Subheader*GEOM*TEXT SET " +matchAllData.getSetup().getTournament()+ "\0", print_writers);
	...
	public String PopulateFfBody(int WhichSide, String whatToProcess, MatchAllData matchAllData, int WhichInning) throws ParseException, InterruptedException 
	{
		...
		case "F4":
			return populatePartnershipListBody(WhichSide, whatToProcess, matchAllData, WhichInning);
			
		case "Alt_Shift_R":
			return FixtureAndResultBody(WhichSide, whatToProcess, matchAllData, WhichInning);
			...
			case Constants.NPL:
				...
				for(int i=0; i<2; i++) {
					...
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$1$Data$Stat_1" + containerName + "$txt_Desig*GEOM*TEXT SET " + "MATCHES" + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$1$Data$Stat_2" + containerName + "$txt_Desig*GEOM*TEXT SET " + "RUNS" + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$2$Data$Stat_1" + containerName + "$txt_Desig*GEOM*TEXT SET " + "THIRTIES" + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$2$Data$Stat_2" + containerName + "$txt_Desig*GEOM*TEXT SET " + "FIFTIES" + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$3$Data$Stat_1" + containerName + "$txt_Desig*GEOM*TEXT SET " + "AVERAGE" + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$3$Data$Stat_2" + containerName + "$txt_Desig*GEOM*TEXT SET " + "STRIKE RATE" + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$4$Data$Stat_1" + containerName + "$txt_Desig*GEOM*TEXT SET " + "BEST SCORE" + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$Stats$1$Data$Stat_1" + containerName + "$txt_Fig*GEOM*TEXT SET " + (tournament.getMatches() != 0 ? tournament.getMatches() : "-") + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$Stats$1$Data$Stat_2" + containerName + "$txt_Fig*GEOM*TEXT SET " + (tournament.getRuns() != 0 ? tournament.getRuns() : "-") + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$Stats$2$Data$Stat_1" + containerName + "$txt_Fig*GEOM*TEXT SET " + (tournament.getThirty() != 0 ? tournament.getThirty() : "-") + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$Stats$2$Data$Stat_2" + containerName + "$txt_Fig*GEOM*TEXT SET " + (tournament.getFifty() != 0 ? tournament.getFifty() : "-") + "\0", print_writers);
					...
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$Stats$3$Data$Stat_2" + containerName + "$txt_Fig*GEOM*TEXT SET " + CricketFunctions.generateStrikeRate(tournament.getRuns(), tournament.getBallsFaced(), 0) + "\0", print_writers);
						...
						if(top_batsman_beststats.get(j).getPlayerId() == player.getPlayerId()) {
							if(top_batsman_beststats.get(j).getBestEquation() % 2 == 0) {
								if(top_batsman_beststats.get(j).getBestEquation()/2 == 0) {
									...
									CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
											+ "$Stats$4$Data$Stat_1" + containerName + "$Justify$txt_VersusTeam*GEOM*TEXT SET "+top_batsman_beststats.get(j).getOpponentTeam().getTeamName1().toUpperCase()+"\0", print_writers);
								}
							}else {
								CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
				...
				if(config.getPrimaryIpAddress().equalsIgnoreCase(Constants.LOCALHOST)) {
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$ImageGrp"
							+ "$img_PlayerPhoto*TEXTURE*IMAGE SET "+ Constants.NPL_LOCAL_PHOTO_PATH + "\\\\" + team.getTeamName4()+"\\\\"
							+ player.getPhoto()+ CricketUtil.PNG_EXTENSION + "\0", print_writers);
				}else {
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$ImageGrp"
							+ "$img_PlayerPhoto*TEXTURE*IMAGE SET "+"\\\\"+config.getPrimaryIpAddress()+"\\\\"+ Constants.NPL_PHOTO_PATH + team.getTeamName4()+"\\\\"
							+ player.getPhoto()+ CricketUtil.PNG_EXTENSION + "\0", print_writers);
				}
				break;
			case Constants.BENGAL_T20:
			...
			case Constants.NPL:
				...
				for(int i=0; i<2; i++) {
					...
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$1$Data$Stat_2" + containerName + "$txt_Desig*GEOM*TEXT SET " + "RUNS" + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$2$Data$Stat_1" + containerName + "$txt_Desig*GEOM*TEXT SET " + "FIFTIES" + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$2$Data$Stat_2" + containerName + "$txt_Desig*GEOM*TEXT SET " + "HUNDREDS" + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$3$Data$Stat_1" + containerName + "$txt_Desig*GEOM*TEXT SET " + "AVERAGE" + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$3$Data$Stat_2" + containerName + "$txt_Desig*GEOM*TEXT SET " + "STRIKE RATE" + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$4$Data$Stat_1" + containerName + "$txt_Desig*GEOM*TEXT SET " + "BEST SCORE" + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$Stats$1$Data$Stat_1" + containerName + "$txt_Fig*GEOM*TEXT SET " + (stat.getMatches() != null ? stat.getMatches() : "-") + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$Stats$1$Data$Stat_2" + containerName + "$txt_Fig*GEOM*TEXT SET " + (stat.getRuns() != null ? stat.getRuns() : "-") + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$Stats$2$Data$Stat_1" + containerName + "$txt_Fig*GEOM*TEXT SET " + (stat.getFifties() != null ? stat.getFifties() : "-") + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$Stats$2$Data$Stat_2" + containerName + "$txt_Fig*GEOM*TEXT SET " + (stat.getHundreds() != null ? stat.getHundreds() : "-") + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$Main$AllGraphics$Side" + WhichSide + "$Select_GraphicsType$Profile$Stats"
					...
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$Stats$3$Data$Stat_2" + containerName + "$txt_Fig*GEOM*TEXT SET " + CricketFunctions.generateStrikeRate(stat.getRuns(), stat.getBalls_faced(), 0) + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$Stats$4$Data$Stat_1" + containerName + "$Justify$txt_Fig*GEOM*TEXT SET " + (stat.getBest_score() != null ? stat.getBest_score() : "-") + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$Stats$4$Data$Stat_1" + containerName + "$Justify$txt_VersusTeam*GEOM*TEXT SET " + (stat.getBest_score_against() != null ? "v "+ stat.getBest_score_against().toUpperCase() : "") + "\0", print_writers);
				}
				if(config.getPrimaryIpAddress().equalsIgnoreCase(Constants.LOCALHOST)) {
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$ImageGrp"
							+ "$img_PlayerPhoto*TEXTURE*IMAGE SET "+ Constants.NPL_LOCAL_PHOTO_PATH + "\\\\" + team.getTeamName4()+"\\\\"
			...
			case Constants.NPL:
				...
				for(int i=0; i<2; i++) {
					...
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$1$Data$Stat_1" + containerName + "$txt_Desig*GEOM*TEXT SET " + "MATCHES" + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$1$Data$Stat_2" + containerName + "$txt_Desig*GEOM*TEXT SET " + "WICKETS" + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$2$Data$Stat_1" + containerName + "$txt_Desig*GEOM*TEXT SET " + "ECONOMY" + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$2$Data$Stat_2" + containerName + "$txt_Desig*GEOM*TEXT SET " + "AVERAGE" + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$3$Data$Stat_1" + containerName + "$txt_Desig*GEOM*TEXT SET " + "STRIKE RATE" + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$3$Data$Stat_2" + containerName + "$txt_Desig*GEOM*TEXT SET " + "3WI" + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$4$Data$Stat_1" + containerName + "$txt_Desig*GEOM*TEXT SET " + "BEST FIGURES" + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$Stats$1$Data$Stat_1" + containerName + "$txt_Fig*GEOM*TEXT SET " + (tournament.getMatches() != 0 ? tournament.getMatches() : "-") + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$Stats$1$Data$Stat_2" + containerName + "$txt_Fig*GEOM*TEXT SET " + (tournament.getWickets() != 0 ? tournament.getWickets() : "-") + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
					...
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$Stats$2$Data$Stat_2" + containerName + "$txt_Fig*GEOM*TEXT SET " + String.format("%.01f", (float)tournament.getRunsConceded() / (float)(tournament.getWickets())) + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$Main$AllGraphics$Side" + WhichSide + "$Select_GraphicsType$Profile$Stats"
							+ "$Stats$3$Data$Stat_1" + containerName + "$txt_Fig*GEOM*TEXT SET " + String.format("%.01f", (float)tournament.getBallsBowled() /(float)(tournament.getWickets())) + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$Stats$3$Data$Stat_2" + containerName + "$txt_Fig*GEOM*TEXT SET " + (tournament.getThreeWicketHaul() != 0 ? tournament.getThreeWicketHaul() : "-") + "\0", print_writers);
					for(int j=0;j<= top_bowler_beststats.size()-1;j++) {
						if(top_bowler_beststats.get(j).getPlayerId() == player.getPlayerId()) {
							...
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
									+ "$Stats$4$Data$Stat_1" + containerName + "$Justify$txt_VersusTeam*GEOM*TEXT SET "+top_bowler_beststats.get(j).getOpponentTeam().getTeamName1().toUpperCase()+"\0", print_writers);
							break;
			...
			case Constants.NPL:
				...
				for(int i=0; i<2; i++) {
					...
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$1$Data$Stat_2" + containerName + "$txt_Desig*GEOM*TEXT SET " + "WICKETS" + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$2$Data$Stat_1" + containerName + "$txt_Desig*GEOM*TEXT SET " + "3WI" + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$2$Data$Stat_2" + containerName + "$txt_Desig*GEOM*TEXT SET " + "5WI" + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$3$Data$Stat_1" + containerName + "$txt_Desig*GEOM*TEXT SET " + "AVERAGE" + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$3$Data$Stat_2" + containerName + "$txt_Desig*GEOM*TEXT SET " + "ECONOMY" + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$4$Data$Stat_1" + containerName + "$txt_Desig*GEOM*TEXT SET " + "BEST FIGURES" + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$Stats$1$Data$Stat_1" + containerName + "$txt_Fig*GEOM*TEXT SET " + (stat.getMatches() != null ? stat.getMatches() : "-") + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$Stats$1$Data$Stat_2" + containerName + "$txt_Fig*GEOM*TEXT SET " + (stat.getWickets() != null ? stat.getWickets() : "-") + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$Stats$2$Data$Stat_1" + containerName + "$txt_Fig*GEOM*TEXT SET " + (stat.getPlus_3() != null ? stat.getPlus_3() : "-") + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$Stats$2$Data$Stat_2" + containerName + "$txt_Fig*GEOM*TEXT SET " + (stat.getPlus_5() != null ? stat.getPlus_5() : "-") + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$Main$AllGraphics$Side" + WhichSide + "$Select_GraphicsType$Profile$Stats"
							+ "$Stats$3$Data$Stat_1" + containerName + "$txt_Fig*GEOM*TEXT SET " + (stat.getWickets() != null && stat.getWickets() == 0 ? "-" : df.format(average)) + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
					...
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$Stats$4$Data$Stat_1" + containerName + "$Justify$txt_Fig*GEOM*TEXT SET " + (stat.getBest_figures() != null ? stat.getBest_figures() : "-") + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$Stats"
							+ "$Stats$4$Data$Stat_1" + containerName + "$Justify$txt_VersusTeam*GEOM*TEXT SET " + (stat.getBest_figures_against() != null ? "v "+ stat.getBest_figures_against().toUpperCase() : "") + "\0", print_writers);
				}
				if(config.getPrimaryIpAddress().equalsIgnoreCase(Constants.LOCALHOST)) {
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Profile$ImageGrp"
							+ "$img_PlayerPhoto*TEXTURE*IMAGE SET "+ Constants.NPL_LOCAL_PHOTO_PATH + "\\\\" + team.getTeamName4()+"\\\\"
		...
		case "Shift_F8":
			...
			case Constants.NPL:
				...
				for(Player plyr : PlayingXI) {
					...
					if(plyr.getRole().equalsIgnoreCase("BATSMAN") || 
							plyr.getRole().equalsIgnoreCase("BATTER") || plyr.getRole().equalsIgnoreCase("BAT/KEEPER")) {
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$TeamSingle$Team$"
								+ rowId +"$Data$txt_Description*GEOM*TEXT SET BATSMAN\0", print_writers);
					}
					else if(plyr.getRole().equalsIgnoreCase("BOWLER")) {
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$TeamSingle$Team$"
								+ rowId +"$Data$txt_Description*GEOM*TEXT SET BOWLER\0", print_writers);
					}
					else if(plyr.getRole().equalsIgnoreCase("ALL-ROUNDER")) {
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$TeamSingle$Team$"
								+ rowId +"$Data$txt_Description*GEOM*TEXT SET ALL-ROUNDER\0", print_writers);
					}
					if(plyr.getSurname() != null) {
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$TeamSingle$Team$"
								+ rowId +"$Data$txt_FirstName*GEOM*TEXT SET " + plyr.getFirstname() + "\0", print_writers);
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$TeamSingle$Team$"
								+ rowId +"$Data$txt_LastName*GEOM*TEXT SET " + plyr.getSurname() + "\0", print_writers);
					}else {
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$TeamSingle$Team$"
								+ rowId +"$Data$txt_FirstName*GEOM*TEXT SET " + plyr.getFull_name() + "\0", print_writers);
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$TeamSingle$Team$"
								+ rowId +"$Data$txt_LastName*GEOM*TEXT SET \0", print_writers);
					}
				}
				for(int i=1; i<=5; i++) {
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$TeamSingle$Substitues$"
							+ i +"*ACTIVE SET 0\0", print_writers);
				}
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$TeamSingle$Substitues$Title"
						+"*ACTIVE SET 0\0", print_writers);
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$TeamSingle$Substitues$Title"
						 +"$txt_Title*GEOM*TEXT SET SUBSTITUTES\0", print_writers);
				rowId = 0;
				if(otherSquad != null && !otherSquad.isEmpty()) {
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$TeamSingle$Substitues$Title"
							+"*ACTIVE SET 1\0", print_writers);
		...
		case "Alt_z":
			...
			case Constants.NPL:
				...
				for(Player plyr : Players) {
					...
					if(plyr.getTeamId() == team.getTeamId() && plyr.getSquad() != null && plyr.getSquad().equalsIgnoreCase("YES")) {
						if(rowId>= 23) {
							break;
						}
						rowId++;
						if(plyr.getSurname() != null) {
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Squad$"
									+ rowId +"$txt_BatterFirstName*GEOM*TEXT SET " + plyr.getFirstname() + "\0", print_writers);
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Squad$"
									+ rowId +"$txt_BatterLastName*GEOM*TEXT SET " + plyr.getSurname() + "\0", print_writers);
						}else {
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Squad$"
									+ rowId +"$txt_BatterFirstName*GEOM*TEXT SET " + plyr.getFull_name() + "\0", print_writers);
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Squad$"
									+ rowId +"$txt_BatterLastName*GEOM*TEXT SET \0", print_writers);
						}
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Squad$"
								+ rowId +"$txt_Description*GEOM*TEXT SET " + plyr.getRole().toUpperCase() + "\0", print_writers);
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Squad$"
								+ rowId +"*ACTIVE SET 1\0", print_writers);
					}
				}
...
//						}
		...
		case "m": //MATCH Ident
			...
			switch (config.getBroadcaster().toUpperCase()) {
			case Constants.NPL:
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Ident$Main$Footer$txt_Footer"
		...
		case "Control_m": //MATCH PROMO
			...
			case Constants.NPL:
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Ident$Main$HeaderGrp$txt_SubHead"
						+ "*GEOM*TEXT SET "+matchAllData.getSetup().getTournament()+" - "+match_name+"\0", print_writers);
				Calendar cal = Calendar.getInstance();
				cal.add(Calendar.DATE, +1);
	...
	public String PopulateFfFooter(int WhichSide, String whatToProcess, MatchAllData matchAllData, int WhichInning) 
	{
		...
		case Constants.NPL:
			...
			case "F1": case "F2": case "F4": case "Control_Shift_F1": case "Control_Shift_F2": case "Control_Shift_F4":
				...
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$Footer$Side" + WhichSide + "$txt_Overs_Value"
						+ "*GEOM*TEXT SET "+CricketFunctions.OverBalls(inning.getTotalOvers(), inning.getTotalBalls())+"\0", print_writers);
				if(matchAllData.getSetup().getTargetOvers() != null && !matchAllData.getSetup().getTargetOvers().isEmpty()) {
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$Footer$Side" + WhichSide + "$txt_Overs_2"
			...
			case "Control_d": case "Control_e": case "Shift_P": case "Shift_Q":
				for(VariousText vt : VariousText) {
					if(vt.getVariousType().equalsIgnoreCase("PROFILEFOOTER") && vt.getUseThis().equalsIgnoreCase(CricketUtil.YES)) {
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$Footer$Side" + WhichSide + "$Select_FooterType"
								+ "*FUNCTION*Omo*vis_con SET 3\0", print_writers);
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$Footer$Side"+WhichSide+"$Select_FooterType"
								+ "$InfoMiddle$txt_Info*GEOM*TEXT SET " + vt.getVariousText() + "\0", print_writers);
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$Footer*ACTIVE SET 1\0", print_writers);
					}else if(vt.getVariousType().equalsIgnoreCase("PROFILEFOOTER") && vt.getUseThis().equalsIgnoreCase(CricketUtil.NO)) {
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$Footer$Side" + WhichSide + "$Select_FooterType"
								+ "*FUNCTION*Omo*vis_con SET 0\0", print_writers);
					}
				}
				...
				for(VariousText vt : VariousText) {
					if(vt.getVariousType().equalsIgnoreCase("POINTSTABLEFOOTER") && vt.getUseThis().toUpperCase().equalsIgnoreCase(CricketUtil.YES)) {
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$FooterAll$Text_In$Side" + WhichSide + "$Info_Text$"
								+ "txt_Overs*GEOM*TEXT SET " + vt.getVariousText() + "\0", print_writers);
					}else {
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$FooterAll$Text_In$Side" + WhichSide + "$Info_Text$"
...
//				}
	...
	public String FixtureAndResultBody(int WhichSide, String whatToProcess, MatchAllData matchAllData, int WhichInning) {
		switch (config.getBroadcaster().toUpperCase()) {
		case Constants.BENGAL_T20:
			CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + 
					"$Select_GraphicsType*FUNCTION*Omo*vis_con SET 11 \0", print_writers);
			CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Team_Fixtures$"
					+ "Rows*FUNCTION*Grid*num_row SET " + FixturesList.size() + "\0", print_writers);
			
			Calendar cal_bengal = Calendar.getInstance();
			cal_bengal.add(Calendar.DATE, 0);
			containerName = "";
			...
			for(int i=0;i<= FixturesList.size()-1;i++) {
				...
				if(FixturesList.get(i).getDate().equalsIgnoreCase(new SimpleDateFormat("dd-MM-yyyy").format(cal_bengal.getTime()))) {
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Team_Fixtures$" + (i+1)
							+ "$Select_Highlight*FUNCTION*Omo*vis_con SET 1 \0", print_writers);
					containerName = "Highlight";
				}else {
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Team_Fixtures$" + (i+1)
				...
				if(team.getTeamId() == FixturesList.get(i).getHometeamid()) {
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Team_Fixtures$" + (i+1)
						+ "$TeamFixturesData$" + containerName + "$Name$txt_Oponent_Name*GEOM*TEXT SET " + FixturesList.get(i).getAway_Team().getTeamName1() + "\0", print_writers);
					
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Team_Fixtures$" + (i+1)
							+ "$BandGrp$img_Base2*TEXTURE*IMAGE SET " + Constants.BENGAL_BASE_PATH + "2/" + FixturesList.get(i).getAway_Team().getTeamName4() + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Team_Fixtures$" + (i+1)
							+ "$BandGrp$img_Base3*TEXTURE*IMAGE SET " + Constants.BENGAL_BASE_PATH + "3/" + FixturesList.get(i).getAway_Team().getTeamName4() + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Team_Fixtures$" + (i+1)
							+ "$BandGrp$img_Base1*TEXTURE*IMAGE SET " + Constants.BENGAL_BASE_PATH + "1/" + FixturesList.get(i).getAway_Team().getTeamName4() + "\0", print_writers);
					
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Team_Fixtures$" + (i+1)
							+ "$Highlight$Data$img_Text1*TEXTURE*IMAGE SET " + Constants.BENGAL_TEXT_PATH + "1/" + FixturesList.get(i).getAway_Team().getTeamName4() + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Team_Fixtures$" + (i+1)
							+ "$Highlight$Data$img_Text2*TEXTURE*IMAGE SET " + Constants.BENGAL_TEXT_PATH + "2/" + FixturesList.get(i).getAway_Team().getTeamName4() + "\0", print_writers);
					
				}else if(team.getTeamId() == FixturesList.get(i).getAwayteamid()) {
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Team_Fixtures$" + (i+1)
						+ "$TeamFixturesData$" + containerName + "$Name$txt_Oponent_Name*GEOM*TEXT SET " + FixturesList.get(i).getHome_Team().getTeamName1() + "\0", print_writers);
					
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Team_Fixtures$" + (i+1)
							+ "$BandGrp$img_Base2*TEXTURE*IMAGE SET " + Constants.BENGAL_BASE_PATH + "2/" + FixturesList.get(i).getHome_Team().getTeamName4() + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Team_Fixtures$" + (i+1)
							+ "$BandGrp$img_Base3*TEXTURE*IMAGE SET " + Constants.BENGAL_BASE_PATH + "3/" + FixturesList.get(i).getHome_Team().getTeamName4() + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Team_Fixtures$" + (i+1)
							+ "$BandGrp$img_Base1*TEXTURE*IMAGE SET " + Constants.BENGAL_BASE_PATH + "1/" + FixturesList.get(i).getHome_Team().getTeamName4() + "\0", print_writers);
					
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Team_Fixtures$" + (i+1)
							+ "$Highlight$Data$img_Text1*TEXTURE*IMAGE SET " + Constants.BENGAL_TEXT_PATH + "1/" + FixturesList.get(i).getHome_Team().getTeamName4() + "\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Team_Fixtures$" + (i+1)
				...
				if(FixturesList.get(i).getMargin() != null && !FixturesList.get(i).getMargin().isEmpty()) {
					...
					if(FixturesList.get(i).getDate().equalsIgnoreCase(new SimpleDateFormat("dd-MM-yyyy").format(cal_bengal.getTime()))) {
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Team_Fixtures$" + (i+1)
								+ "$TeamFixturesData$" + containerName + "$Info$txt_Info*GEOM*TEXT SET " + "TODAY" + "\0", print_writers);
					}else {
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Team_Fixtures$" + (i+1)
							+ "$TeamFixturesData$" + containerName + "$Info$txt_Info*GEOM*TEXT SET " + CricketFunctions.ordinal(Integer.valueOf(FixturesList.get(i).getDate().split("-")[0]))
	...
	public String ScoreCardBody(int WhichSide, String whatToProcess, MatchAllData matchAllData, int WhichInning) {
		...
		boolean isReplacePlayerStillToBat = false, isImpactPlayerStillToBat = false, impactPlayerDataFilled = false;
		//impactList.clear();
		...
		case Constants.NPL:
			...
			rowId = 0;
			com.cricket.model.ImpactData[] impactData= CricketFunctions.getImpactPlayerList(matchAllData, cricketService);
			Collections.sort(inning.getBattingCard());
			for (BattingCard bc : inning.getBattingCard()) {
				rowId++;
				if(impactData != null) {
					if(impactData[0] != null) {
						if(inning.getBatting_team().getTeamId() == impactData[0].getTeamId()) {
							if(bc.getPlayerId() == impactData[0].getOutPlayerId()) {
								...
								if(!inning.getBattingCard().stream().filter(btc -> btc.getPlayerId() == impactData[0].getInPlayerId()).findFirst().isPresent()) {
									impactPlayer = cricketService.getAllPlayer().get(impactData[0].getInPlayerId()-1);
					...
					if(impactData[1] != null) {
						if(inning.getBatting_team().getTeamId() == impactData[1].getTeamId()) {
							if(bc.getPlayerId() == impactData[1].getOutPlayerId()) {
								if(bc.getStatus().equalsIgnoreCase(CricketUtil.STILL_TO_BAT)) {
									isReplacePlayerStillToBat = true;
								}
								if(!inning.getBattingCard().stream().filter(btc -> btc.getPlayerId() == impactData[1].getInPlayerId()).findFirst().isPresent()) {
									impactPlayer = cricketService.getAllPlayer().get(impactData[0].getInPlayerId()-1);
									if(isReplacePlayerStillToBat == true) {
										isImpactPlayerStillToBat = true;
									}
				...
				case CricketUtil.STILL_TO_BAT:
					if(bc.getHowOut() == null) {
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
								+"$BattingCard$"+ rowId +"$Select_Row_Type*FUNCTION*Omo*vis_con SET 0\0", print_writers);
						
						if(bc.getPlayer().getSurname() != null) {
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
									+"$BattingCard$"+ rowId+"$Out$Still_To_Bat$txt_BatterFirstName*GEOM*TEXT SET "+bc.getPlayer().getFirstname()+"\0", print_writers);
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
									+"$BattingCard$"+ rowId+"$Out$Still_To_Bat$txt_BatterLastName*GEOM*TEXT SET "+bc.getPlayer().getSurname()+"\0", print_writers);
						}else {
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
									+"$BattingCard$"+ rowId+"$Out$Still_To_Bat$txt_BatterFirstName*GEOM*TEXT SET "+bc.getPlayer().getFull_name()+"\0", print_writers);
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
									+"$BattingCard$"+ rowId+"$Out$Still_To_Bat$txt_BatterLastName*GEOM*TEXT SET "+""+"\0", print_writers);
						}
						if(CricketFunctions.isImpactPlayer(matchAllData.getEventFile().getEvents(), inning.getInningNumber(), bc.getPlayerId()).equalsIgnoreCase(CricketUtil.YES)) {
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
									+"$BattingCard$"+ rowId +"$Still_To_Bat$Select_Impact*FUNCTION*Omo*vis_con SET 1\0", print_writers);
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
									+"$BattingCard$"+ rowId +"$Still_To_Bat$Name_Grp*FUNCTION*Maxsize*WIDTH_X SET 505\0", print_writers);
						} else {
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
									+"$BattingCard$"+ rowId +"$Still_To_Bat$Select_Impact*FUNCTION*Omo*vis_con SET 0\0", print_writers);
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
									+"$BattingCard$"+ rowId +"$Still_To_Bat$Name_Grp*FUNCTION*Maxsize*WIDTH_X SET 625.0\0", print_writers);
						}
						if(impactData != null) {
							if(impactData[0] != null) {
								if(impactData[0].getOutPlayerId() == bc.getPlayerId()) {
									CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
											+"$BattingCard$"+ rowId +"$Still_To_Bat$Select_Impact*FUNCTION*Omo*vis_con SET 2\0", print_writers);
									CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
											+"$BattingCard$"+ rowId +"$Still_To_Bat$Name_Grp*FUNCTION*Maxsize*WIDTH_X SET 505\0", print_writers);
								}
							}
							if(impactData[1] != null) {
								if(impactData[1].getOutPlayerId() == bc.getPlayerId()) {
									CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
											+"$BattingCard$"+ rowId +"$Still_To_Bat$Select_Impact*FUNCTION*Omo*vis_con SET 2\0", print_writers);
									CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
											+"$BattingCard$"+ rowId +"$Still_To_Bat$Name_Grp*FUNCTION*Maxsize*WIDTH_X SET 505\0", print_writers);
						...
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
								+"$BattingCard$"+ rowId +"$Select_Row_Type*FUNCTION*Omo*vis_con SET 1\0", print_writers);
						
						if(bc.getPlayer().getSurname() != null) {
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
									+"$BattingCard$"+ rowId+"$Out$Out$txt_BatterFirstName*GEOM*TEXT SET "+bc.getPlayer().getFirstname()+"\0", print_writers);
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
									+"$BattingCard$"+ rowId+"$Out$Out$txt_BatterLastName*GEOM*TEXT SET "+bc.getPlayer().getSurname()+"\0", print_writers);
						}else {
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
									+"$BattingCard$"+ rowId+"$Out$Out$txt_BatterFirstName*GEOM*TEXT SET "+bc.getPlayer().getFull_name()+"\0", print_writers);
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
									+"$BattingCard$"+ rowId+"$Out$Out$txt_BatterLastName*GEOM*TEXT SET "+""+"\0", print_writers);
						}
						
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
								+"$BattingCard$"+ rowId +"$Out$HowOut1$txt_OutType*GEOM*TEXT SET "+bc.getHowOut().replace("_", " ").toLowerCase()+"\0", print_writers);
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
								+"$BattingCard$"+ rowId +"$Out$HowOut1$txt_FielderName*GEOM*TEXT SET \0", print_writers);
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
								+"$BattingCard$"+ rowId +"$Out$HowOut2$txt_Bold*GEOM*TEXT SET \0", print_writers);
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
								+"$BattingCard$"+ rowId +"$Out$HowOut2$txt_BowlerName*GEOM*TEXT SET \0", print_writers);
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
								+"$BattingCard$"+ rowId +"$Out$txt_Runs*GEOM*TEXT SET "+bc.getRuns()+"\0", print_writers);
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
								+"$BattingCard$"+ rowId +"$Out$txt_Balls*GEOM*TEXT SET "+bc.getBalls()+"\0", print_writers);
						if(CricketFunctions.isImpactPlayer(matchAllData.getEventFile().getEvents(), inning.getInningNumber(), bc.getPlayerId()).equalsIgnoreCase(CricketUtil.YES)) {
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
									+"$BattingCard$"+ rowId +"$Out$Out$Select_Impact*FUNCTION*Omo*vis_con SET 1\0", print_writers);
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
									+"$BattingCard$"+ rowId +"$Out$Out$Name_Grp*FUNCTION*Maxsize*WIDTH_X SET 505\0", print_writers);
						} else {
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
									+"$BattingCard$"+ rowId +"$Out$Out$Select_Impact*FUNCTION*Omo*vis_con SET 0\0", print_writers);
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
									+"$BattingCard$"+ rowId +"$Out$Out$Name_Grp*FUNCTION*Maxsize*WIDTH_X SET 625.0\0", print_writers);
						}
						if(impactData != null) {
							if(impactData[0] != null) {
								if(impactData[0].getOutPlayerId() == bc.getPlayerId()) {
									CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
											+"$BattingCard$"+ rowId +"$Out$Out$Select_Impact*FUNCTION*Omo*vis_con SET 2\0", print_writers);
									CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
											+"$BattingCard$"+ rowId +"$Out$Out$Name_Grp*FUNCTION*Maxsize*WIDTH_X SET 505\0", print_writers);
								}
							}
						...
						if(bc.getPlayer().getSurname() != null) {
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
									+"$BattingCard$"+ rowId+"$Out$txt_BatterFirstName*GEOM*TEXT SET "+bc.getPlayer().getFirstname()+"\0", print_writers);
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
									+"$BattingCard$"+ rowId+"$Out$txt_BatterLastName*GEOM*TEXT SET "+bc.getPlayer().getSurname()+"\0", print_writers);
						}else {
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
									+"$BattingCard$"+ rowId+"$Out$txt_BatterFirstName*GEOM*TEXT SET "+bc.getPlayer().getFull_name()+"\0", print_writers);
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide 
									+"$BattingCard$"+ rowId+"$Out$txt_BatterLastName*GEOM*TEXT SET "+""+"\0", print_writers);
						}
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
								+"$BattingCard$"+ rowId +"$Out$HowOut1$txt_OutType*GEOM*TEXT SET "+bc.getHowOut().replace("_", " ").toLowerCase()+"\0", print_writers);
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
				...
				default:
					...
					case CricketUtil.NOT_OUT:
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
								+"$BattingCard$"+ rowId +"$Select_Row_Type*FUNCTION*Omo*vis_con SET 2\0", print_writers);
						containerName = "$Out$Not_Out";
						break;
					}
					if(CricketFunctions.isImpactPlayer(matchAllData.getEventFile().getEvents(), inning.getInningNumber(), bc.getPlayerId()).equalsIgnoreCase(CricketUtil.YES)) {
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
								+"$BattingCard$"+ rowId + containerName +"$Select_Impact*FUNCTION*Omo*vis_con SET 1\0", print_writers);
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
								+"$BattingCard$"+ rowId + containerName +"$Name_Grp*FUNCTION*Maxsize*WIDTH_X SET 505\0", print_writers);
					} else {
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
								+"$BattingCard$"+ rowId +containerName+"$Select_Impact*FUNCTION*Omo*vis_con SET 0\0", print_writers);
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
								+"$BattingCard$"+ rowId +containerName+"$Name_Grp*FUNCTION*Maxsize*WIDTH_X SET 625.0\0", print_writers);
					}
					if(impactData != null) {
						if(impactData[0] != null) {
							if(impactData[0].getOutPlayerId() == bc.getPlayerId()) {
								CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
										+"$BattingCard$"+ rowId +containerName+"$Select_Impact*FUNCTION*Omo*vis_con SET 2\0", print_writers);
								CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
										+"$BattingCard$"+ rowId +containerName+"$Name_Grp*FUNCTION*Maxsize*WIDTH_X SET 505\0", print_writers);
							}
						}
					...
					if(bc.getPlayer().getSurname() != null) {
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
								+"$BattingCard$"+ rowId + containerName+"$txt_BatterFirstName*GEOM*TEXT SET "+bc.getPlayer().getFirstname()+"\0", print_writers);
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
								+"$BattingCard$"+ rowId +containerName+"$txt_BatterLastName*GEOM*TEXT SET "+bc.getPlayer().getSurname()+"\0", print_writers);
					}else {
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
								+"$BattingCard$"+ rowId +containerName+"$txt_BatterFirstName*GEOM*TEXT SET "+bc.getPlayer().getFull_name()+"\0", print_writers);
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
								+"$BattingCard$"+ rowId +containerName+"$txt_BatterLastName*GEOM*TEXT SET "+""+"\0", print_writers);
					}
					
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
							+"$BattingCard$"+ rowId +containerName+"$txt_Runs*GEOM*TEXT SET "+bc.getRuns()+"\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
							+"$BattingCard$"+ rowId +containerName+"$txt_Balls*GEOM*TEXT SET "+bc.getBalls()+"\0", print_writers);
					
					how_out_txt = CricketFunctions.processHowOutText("FOUR-PART-HOW-OUT", bc);
					if(how_out_txt != null && how_out_txt.split("|").length >= 4) {
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
								+"$BattingCard$"+ rowId +containerName+"$HowOut1$txt_OutType*GEOM*TEXT SET "+how_out_txt.split("\\|")[0].trim()+"\0", print_writers);
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
								+"$BattingCard$"+ rowId +containerName+"$HowOut1$txt_FielderName*GEOM*TEXT SET "+how_out_txt.split("\\|")[1].trim().replace("substitute", "sub")+"\0", print_writers);
						
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide 
								+"$BattingCard$"+ rowId +containerName+"$HowOut2$txt_Bold*GEOM*TEXT SET "+how_out_txt.split("\\|")[2].trim()+"\0", print_writers);
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
								+"$BattingCard$"+ rowId +containerName+"$HowOut2$txt_BowlerName*GEOM*TEXT SET "+how_out_txt.split("\\|")[3].trim()+"\0", print_writers);
					}else {
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
			...
			CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
					 +"$BattingCard$Select_NumberOfRows*FUNCTION*Grid*num_row SET "+rowId+"\0", print_writers);
			
			if(impactPlayerDataFilled == false && impactPlayer != null) {
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
						 +"$BattingCard$Select_NumberOfRows*FUNCTION*Grid*num_row SET "+(rowId+1)+"\0", print_writers);
				
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
						+"$BattingCard$"+ (rowId+1) +"$Select_Row_Type*FUNCTION*Omo*vis_con SET 0\0", print_writers);
				if(impactPlayer.getSurname() != null) {
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
							+"$BattingCard$"+ (rowId+1)+"$Out$Still_To_Bat$txt_BatterFirstName*GEOM*TEXT SET "+impactPlayer.getFirstname()+"\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
							+"$BattingCard$"+ (rowId+1)+"$Out$Still_To_Bat$txt_BatterLastName*GEOM*TEXT SET "+impactPlayer.getSurname()+"\0", print_writers);
				}else {
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
							+"$BattingCard$"+ (rowId+1)+"$Out$Still_To_Bat$txt_BatterFirstName*GEOM*TEXT SET "+impactPlayer.getFull_name()+"\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
							+"$BattingCard$"+ (rowId+1)+"$Out$Still_To_Bat$txt_BatterLastName*GEOM*TEXT SET "+""+"\0", print_writers);
				}
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
						+"$BattingCard$"+ rowId + containerName +"$Select_Impact*FUNCTION*Omo*vis_con SET 1\0", print_writers);
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
				...
				if(impactData != null) {
					if(impactData[0] != null) {
						if(impactData[0].getOutPlayerId() == impactPlayer.getPlayerId()) {
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
									+"$BattingCard$"+ rowId+"$Still_To_Bat$Select_Impact*FUNCTION*Omo*vis_con SET 2\0", print_writers);
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
									+"$BattingCard$"+ rowId +"$Still_To_Bat$Name_Grp*FUNCTION*Maxsize*WIDTH_X SET 505\0", print_writers);
					...
					if(impactData[1] != null) {
						if(impactData[1].getOutPlayerId() == impactPlayer.getPlayerId()) {
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
									+"$BattingCard$"+ rowId +"$Still_To_Bat$Select_Impact*FUNCTION*Omo*vis_con SET 2\0", print_writers);
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
									+"$BattingCard$"+ rowId +"$Still_To_Bat$Name_Grp*FUNCTION*Maxsize*WIDTH_X SET 505\0", print_writers);
...
//					System.out.println(impactArray[i].getInBatPlayerId() +" : " +impactArray[i].getOutPlayerId() +" : "+impactArray[i].getTeamId() +" : "+impactArray[i].getInBowlPlayerId());
//				}
//				
//			}
			rowId = 0;
				...
				case CricketUtil.STILL_TO_BAT:
					if(inning.getBattingCard().get(iRow-1).getHowOut() == null) {
						...
						if (CricketFunctions.checkImpactPlayer(matchAllData.getEventFile().getEvents(), inning.getInningNumber(), 
							...
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide 
									+ "$Batting_Card$" + rowId + "$BattingData$Select_Row_Type$Still_To_Bat$Data$Name$Select_Impact*FUNCTION*Omo*vis_con SET 1 \0", print_writers);
						} else if (CricketFunctions.checkImpactPlayerBowler(matchAllData.getEventFile().getEvents(), inning.getInningNumber(), 
								inning.getBattingCard().get(iRow-1).getPlayerId()).equalsIgnoreCase(CricketUtil.YES)) {
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide 
									+ "$Batting_Card$" + rowId + "$BattingData$Select_Row_Type$Still_To_Bat$Data$Name$Select_Impact*FUNCTION*Omo*vis_con SET 1 \0", print_writers);
							...
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide 
									+ "$Batting_Card$" + rowId + "$BattingData$Select_Row_Type$Still_To_Bat$Data$Name$Select_Impact*FUNCTION*Omo*vis_con SET 0 \0", print_writers);
						}
//						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide 
...
//					System.out.println("how_out_txt = " + how_out_txt);
					if(how_out_txt != null && how_out_txt.split("|").length >= 4) {
						...
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide 
							+ "$Batting_Card$" + rowId + "$BattingData$Select_Row_Type$" + containerName 
							+ "$Data$How_Out_1$txt_FielderName*GEOM*TEXT SET " + how_out_txt.split("\\|")[1].trim().replace("substitute", "sub") + "\0", print_writers);
					}else {
						switch (inning.getBattingCard().get(iRow-1).getStatus().toUpperCase()) {
						case CricketUtil.NOT_OUT:
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide 
	...
	public String BowlingCardBody(int WhichSide, String whatToProcess, MatchAllData matchAllData, int WhichInning) {
		...
		case Constants.NPL:
			...
			CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$BowlingCard"+
					"$1$Select_Row_Type*FUNCTION*Omo*vis_con SET 1 \0", print_writers);
			
			CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide+"$BowlingCard"
					+ "$Select_NumberOfRows*FUNCTION*Grid*num_row SET 11\0", print_writers);
			...
			if(inning.getBowlingCard() != null && inning.getBowlingCard().size() > 0) {
				for(int iRow = 1; iRow <= inning.getBowlingCard().size(); iRow++) {
					if(inning.getBowlingCard().get(iRow-1).getRuns() > 0 || ((inning.getBowlingCard().get(iRow-1).getOvers()*6)
						...
						if(CricketFunctions.isImpactPlayer(matchAllData.getEventFile().getEvents(), inning.getInningNumber(), inning.getBowlingCard().get(iRow-1).getPlayerId()).equalsIgnoreCase(CricketUtil.YES)) {
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
									+"$BowlingCard$"+ (iRow+1) + containerName +"$Select_Impact*FUNCTION*Omo*vis_con SET 1\0", print_writers);
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
									+"$BowlingCard$"+ (iRow+1) + containerName +"$Name_Grp*FUNCTION*Maxsize*WIDTH_X SET 505\0", print_writers);
						} else {
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
									+"$BowlingCard$"+ (iRow+1) +containerName+"$Select_Impact*FUNCTION*Omo*vis_con SET 0\0", print_writers);
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
									+"$BowlingCard$"+ (iRow+1) +containerName+"$Name_Grp*FUNCTION*Maxsize*WIDTH_X SET 625.0\0", print_writers);
						}
						
						if(inning.getBowlingCard().get(iRow-1).getPlayer().getSurname() != null) {
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$BowlingCard$"+
									+ (iRow+1) + "$Select_Row_Type"+containerName+"$txt_BowlerFirstName*GEOM*TEXT SET " + inning.getBowlingCard().get(iRow-1).getPlayer().getFirstname() + "\0", print_writers);
								CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$BowlingCard$"+
										+ (iRow+1) + "$Select_Row_Type"+containerName+"$txt_BowlerLastName*GEOM*TEXT SET " + inning.getBowlingCard().get(iRow-1).getPlayer().getSurname() + "\0", print_writers);
						}else {
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$BowlingCard$"+
									+ (iRow+1) + "$Select_Row_Type"+containerName+"$txt_BowlerFirstName*GEOM*TEXT SET " + inning.getBowlingCard().get(iRow-1).getPlayer().getFull_name() + "\0", print_writers);
								CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$BowlingCard$"+
										+ (iRow+1) + "$Select_Row_Type"+containerName+"$txt_BowlerLastName*GEOM*TEXT SET \0", print_writers);
						}
						
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$BowlingCard$"+
								+ (iRow+1) + "$Select_Row_Type"+containerName+"$Data$txt_Overs*GEOM*TEXT SET " + CricketFunctions.
								OverBalls(inning.getBowlingCard().get(iRow-1).getOvers(), inning.getBowlingCard().get(iRow-1).getBalls()) + "\0", print_writers);
						
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$BowlingCard$"+
								+ (iRow+1) + "$Select_Row_Type"+containerName+"$Data$txt_Maidens*GEOM*TEXT SET " + inning.getBowlingCard().get(iRow-1).getMaidens() + "\0", print_writers);
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$BowlingCard$"+
								+ (iRow+1) + "$Select_Row_Type"+containerName+"$Data$txt_Runs*GEOM*TEXT SET " + inning.getBowlingCard().get(iRow-1).getRuns() + "\0", print_writers);
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$BowlingCard$"+
								+ (iRow+1) + "$Select_Row_Type"+containerName+"$Data$txt_Wickets*GEOM*TEXT SET " + inning.getBowlingCard().get(iRow-1).getWickets() + "\0", print_writers);
						
						if(inning.getBowlingCard().get(iRow-1).getEconomyRate() != null) {
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$BowlingCard$"+
									+ (iRow+1) + "$Select_Row_Type"+containerName+"$Data$txt_Economy*GEOM*TEXT SET " + inning.getBowlingCard().get(iRow-1).getEconomyRate() + "\0", print_writers);
						}else {
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$BowlingCard$"+
									+ (iRow+1) + "$Select_Row_Type"+containerName+"$Data$txt_Economy*GEOM*TEXT SET " + "-" + "\0", print_writers);
						}
					}
				}
			}
			...
			if(inning.getBowlingCard().size() <= 7) {
				...
				if(inning.getFallsOfWickets() != null) {
					...
					for(FallOfWicket fow : inning.getFallsOfWickets()) {
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$BowlingCard$"
							+ "10$Select_Row_Type$Wickets$Data$fig_" + fow.getFowNumber() + "*GEOM*TEXT SET " + fow.getFowNumber() + "\0", print_writers);
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$BowlingCard$"
			...
			if(inning.getBowlingCard() != null && inning.getBowlingCard().size() > 0) {
				for(int iRow = 1; iRow <= inning.getBowlingCard().size(); iRow++) {
					if(inning.getBowlingCard().get(iRow-1).getRuns() > 0 || ((inning.getBowlingCard().get(iRow-1).getOvers()*6)
						...
						if(impactArray != null) {
							if(impactArray[0] != null) {
								if(inning.getBowlingTeamId() == impactArray[0].getTeamId()) {
									if(inning.getBowlingCard().get(iRow-1).getPlayerId() == impactArray[0].getInBowlPlayerId() || 
											inning.getBowlingCard().get(iRow-1).getPlayerId() == impactArray[0].getInBatPlayerId()) {
										impactOmo = 1;
									}else {
										impactOmo = 0;
									}
							...
							if(impactArray[1] != null) {
								if(inning.getBowlingTeamId() == impactArray[1].getTeamId()) {
									if(inning.getBowlingCard().get(iRow-1).getPlayerId() == impactArray[1].getInBowlPlayerId() || 
											inning.getBowlingCard().get(iRow-1).getPlayerId() == impactArray[1].getInBatPlayerId()) {
										impactOmo = 1;
									}else {
										impactOmo = 0;
									}
						...
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide 
								+ "$Bowling_Card$" + (iRow+1) + containerName + "$Data$Select_Impact*FUNCTION*Omo*vis_con SET "+impactOmo+" \0", print_writers);
//						if (CricketFunctions.checkImpactPlayer(matchAllData.getEventFile().getEvents(), inning.getInningNumber(), 
...
//							+ (iRow+1) + "$Select_Row_Type*FUNCTION*Omo*vis_con SET 2 \0", print_writers);
	...
	public String SummaryBody(int WhichSide, String whatToProcess, MatchAllData matchAllData, int WhichInning) {
		switch (config.getBroadcaster().toUpperCase()) {
		case Constants.ISPL: case Constants.ICC_U19_2023: case Constants.BENGAL_T20: case Constants.NPL:
			switch (config.getBroadcaster().toUpperCase()) {
			case Constants.ISPL:
				omo = 2;
				numberOfRows = 3;
			...
			if(config.getBroadcaster().equalsIgnoreCase(Constants.BENGAL_T20)) {
				if(WhichType.equalsIgnoreCase("captain")) {
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Summary$" + containerName + 
							"1$Select_Captain*ACTIVE SET 1 \0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Summary$" + containerName + 
							"2$Select_Captain*ACTIVE SET 1 \0", print_writers);
				...
				else if(WhichType.equalsIgnoreCase("trophy")) {
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Summary$" + containerName + 
							"1$Select_Captain*ACTIVE SET 0 \0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Summary$" + containerName + 
							"2$Select_Captain*ACTIVE SET 0 \0", print_writers);
				}
			...
			for(int i = 1; i <= WhichInning ; i++) {
				...
				if(matchAllData.getMatch().getInning().get(i-1).getBatting_team().getTeamName4().contains("KHILADI XI") || 
					...
					logo_name = matchAllData.getMatch().getInning().get(i-1).getBatting_team().getTeamBadge();
...
//						}
					...
					//CAPTAINS
					if(config.getPrimaryIpAddress().equalsIgnoreCase("LOCALHOST")) {
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$ExtraData$Side" + WhichSide + "$2Captain" + 
								"$img_Player" + i + "*TEXTURE*IMAGE SET " + Constants.NPL_LOCAL_PHOTO_PATH + logo_name + "\\" + Player_photo + CricketUtil.PNG_EXTENSION + " \0", print_writers);
//						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$ExtraData$Side" + WhichSide + "$2Captain$" + 
//								"$img_Player2*TEXTURE*IMAGE SET " + Constants.NPL_LOCAL_PHOTO_PATH + logo_name + "\\" + Player_photo + CricketUtil.PNG_EXTENSION + " \0", print_writers);
					}else {
//						if(!new File("\\\\"+config.getPrimaryIpAddress()+ Constants.BENGAL_PHOTO_PATH + logo_name + "\\" + Player_photo + CricketUtil.PNG_EXTENSION).exists()) {
//							this.status = CricketUtil.UNSUCCESSFUL;
//						}
						...
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$ExtraData$Side" + WhichSide + "$2Captain" + 
								"$img_Player" + i + "*TEXTURE*IMAGE SET " + "\\\\" + config.getPrimaryIpAddress() + Constants.NPL_PHOTO_PATH + logo_name + "\\" + 
									Player_photo + CricketUtil.PNG_EXTENSION + " \0", print_writers);
//						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$ExtraData$Side" + WhichSide + "$2Captain$" + 
//								"$img_Player2*TEXTURE*IMAGE SET " + "\\\\" + config.getPrimaryIpAddress() + Constants.NPL_PHOTO_PATH + logo_name + "\\" + 
//									Player_photo + CricketUtil.PNG_EXTENSION + " \0", print_writers);
					}
					...
					for(BattingCard bc : matchAllData.getMatch().getInning().get(i-1).getBattingCard()) {
						if(bc.getRuns() > 0) {
							...
							if(config.getBroadcaster().equalsIgnoreCase(Constants.NPL)) {
								if(CricketFunctions.isImpactPlayer(matchAllData.getEventFile().getEvents(), inning.getInningNumber(), bc.getPlayerId()).equalsIgnoreCase(CricketUtil.YES)) {
									CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
											+"$Summary$"+containerName+i+"$Row_"+ rowId +"$Batsman$Select_Impact*FUNCTION*Omo*vis_con SET 1\0", print_writers);
									CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
											+"$Summary$"+containerName+i+"$Row_"+ rowId +"$Batsman$txt_Name*FUNCTION*Maxsize*WIDTH_X SET 570.0\0", print_writers);
								} else {
									CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
											+"$Summary$"+containerName+i+"$Row_"+ rowId +"$Batsman$Select_Impact*FUNCTION*Omo*vis_con SET 0\0", print_writers);
									CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
											+"$Summary$"+containerName+i+"Row_"+ rowId +"$Batsman$txt_Name*FUNCTION*Maxsize*WIDTH_X SET 670.0\0", print_writers);
								}
							}
							if(impactData != null) {
								if(impactData[0] != null) {
									if(impactData[0].getOutPlayerId() == bc.getPlayerId()) {
										CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
												+"$Summary$"+containerName+i+"$Row_"+ rowId +"$Batsman$Select_Impact*FUNCTION*Omo*vis_con SET 2\0", print_writers);
										CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
												+"$Summary$"+containerName+i+"$Row_"+ rowId +"$Batsman$txt_Name*FUNCTION*Maxsize*WIDTH_X SET 570.0\0", print_writers);
									}
								}
				...
				if(matchAllData.getMatch().getInning().get(i-1).getBowlingCard() != null) {
					...
					for(BowlingCard boc : matchAllData.getMatch().getInning().get(i-1).getBowlingCard()) {
						...
						if(boc.getWickets() > 0) {
							...
							if(config.getBroadcaster().equalsIgnoreCase(Constants.NPL)) {
								if(CricketFunctions.isImpactPlayer(matchAllData.getEventFile().getEvents(), inning.getInningNumber(), boc.getPlayerId()).equalsIgnoreCase(CricketUtil.YES)) {
									CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
											+"$Summary$"+containerName+i+"$Row_"+ rowId +"$Bowler$Select_Impact*FUNCTION*Omo*vis_con SET 1\0", print_writers);
									CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
											+"$Summary$"+containerName+i+"$Row_"+ rowId +"$Bowler$txt_Name*FUNCTION*Maxsize*WIDTH_X SET 540.0\0", print_writers);
								} else {
									CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
											+"$Summary$"+containerName+i+"$Row_"+ rowId +"$Bowler$Select_Impact*FUNCTION*Omo*vis_con SET 0\0", print_writers);
									CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
											+"$Summary$"+containerName+i+"Row_"+ rowId +"$Bowler$txt_Name*FUNCTION*Maxsize*WIDTH_X SET 640.0\0", print_writers);
								}
							}
							if(impactData != null) {
								if(impactData[0] != null) {
									if(impactData[0].getOutPlayerId() == boc.getPlayerId()) {
										CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
												+"$Summary$"+containerName+i+"$Row_"+ rowId +"$Bowler$Select_Impact*FUNCTION*Omo*vis_con SET 2\0", print_writers);
										CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
												+"$Summary$"+containerName+i+"$Row_"+ rowId +"$Bowler$txt_Name*FUNCTION*Maxsize*WIDTH_X SET 540.0\0", print_writers);
									}
								}
								if(impactData[1] != null) {
									if(impactData[1].getOutPlayerId() == boc.getPlayerId()) {
										CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
												+"$Summary$"+containerName+i+"$Row_"+ rowId +"$Bowler$Select_Impact*FUNCTION*Omo*vis_con SET 2\0", print_writers);
										CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
												+"$Summary$"+containerName+i+"$Row_"+ rowId +"$Bowler$txt_Name*FUNCTION*Maxsize*WIDTH_X SET 540.0\0", print_writers);
...
//									+ i + "$Row_" + rowId + "$Bowler$txt_Not-Out*GEOM*TEXT SET " + "" + "\0", print_writers);
	...
	public String PreviousSummaryBody(int WhichSide, String whatToProcess, MatchAllData matchAllData, int WhichInning) {
		...
		case Constants.ISPL: case Constants.ICC_U19_2023: case Constants.BENGAL_T20: case Constants.NPL:
			...
			ImpactData impactArray[] = new ImpactData[2];
			com.cricket.model.ImpactData[] impactData= CricketFunctions.getImpactPlayerList(previous_match, cricketService);
			...
			for(int i = 1; i <= 2 ; i++) {
				...
				if(previous_match.getMatch().getInning().get(i-1).getBatting_team().getTeamName4().contains("KHILADI XI") || 
					...
					logo_name = previous_match.getMatch().getInning().get(i-1).getBatting_team().getTeamBadge();
				}
				...
				if(previous_match.getMatch().getInning().get(i-1).getBattingCard() != null) {
					...
					for(BattingCard bc : previous_match.getMatch().getInning().get(i-1).getBattingCard()) {
						if(bc.getRuns() > 0) {
							...
							if(config.getBroadcaster().equalsIgnoreCase(Constants.NPL)) {
								if(CricketFunctions.isImpactPlayer(previous_match.getEventFile().getEvents(), inning.getInningNumber(), bc.getPlayerId()).equalsIgnoreCase(CricketUtil.YES)) {
									CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
											+"$Summary$"+containerName+i+"$Row_"+ rowId +"$Batsman$Select_Impact*FUNCTION*Omo*vis_con SET 1\0", print_writers);
									CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
											+"$Summary$"+containerName+i+"$Row_"+ rowId +"$Batsman$txt_Name*FUNCTION*Maxsize*WIDTH_X SET 570.0\0", print_writers);
				...
				if(previous_match.getMatch().getInning().get(i-1).getBowlingCard() != null) {
					...
					for(BowlingCard boc : previous_match.getMatch().getInning().get(i-1).getBowlingCard()) {
						...
						if(boc.getWickets() > 0) {
							...
							if(config.getBroadcaster().equalsIgnoreCase(Constants.NPL)) {
								if(CricketFunctions.isImpactPlayer(previous_match.getEventFile().getEvents(), inning.getInningNumber(), boc.getPlayerId()).equalsIgnoreCase(CricketUtil.YES)) {
									CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
											+"$Summary$"+containerName+i+"$Row_"+ rowId +"$Bowler$Select_Impact*FUNCTION*Omo*vis_con SET 1\0", print_writers);
									CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
											+"$Summary$"+containerName+i+"$Row_"+ rowId +"$Bowler$txt_Name*FUNCTION*Maxsize*WIDTH_X SET 540.0\0", print_writers);
...
//									+ i + "$Row_" + rowId + "$Bowler$txt_Not-Out*GEOM*TEXT SET " + "" + "\0", print_writers);
	...
	public String CurrentPartnershipBody(int WhichSide, String whatToProcess, MatchAllData matchAllData, int WhichInning) {
		switch (config.getBroadcaster().toUpperCase()) {
		case Constants.NPL:
			CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$Main$AllGraphics$Side" + WhichSide + "$Select_GraphicsType" +
					"*FUNCTION*Omo*vis_con SET 4\0", print_writers);
			if(config.getPrimaryIpAddress().equalsIgnoreCase(Constants.LOCALHOST)) {
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Partnership"
						+ "$Photo$PhotoGrp1$img_PlayerPhoto1*TEXTURE*IMAGE SET " + Constants.NPL_LOCAL_PHOTO_PATH + inning.getBatting_team().getTeamName4()+"\\\\"
						+ battingCardList.get(0).getPlayer().getPhoto()+ CricketUtil.PNG_EXTENSION + "\0", print_writers);
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Partnership"
						+ "$Photo$PhotoGrp2$img_PlayerPhoto1*TEXTURE*IMAGE SET " + Constants.NPL_LOCAL_PHOTO_PATH+ inning.getBatting_team().getTeamName4()+"\\\\"
						+ battingCardList.get(1).getPlayer().getPhoto()+ CricketUtil.PNG_EXTENSION + "\0", print_writers);
				
			}else {
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Partnership"
						+ "$Photo$PhotoGrp1$img_PlayerPhoto1*TEXTURE*IMAGE SET " +"\\\\"+config.getPrimaryIpAddress()+"\\"+ Constants.NPL_PHOTO_PATH + inning.getBatting_team().getTeamName4()+"\\\\"
						+ battingCardList.get(0).getPlayer().getPhoto()+ CricketUtil.PNG_EXTENSION + "\0", print_writers);
		
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Partnership"
						+ "$Photo$PhotoGrp2$img_PlayerPhoto1*TEXTURE*IMAGE SET " +"\\\\"+config.getPrimaryIpAddress()+"\\"+ Constants.NPL_PHOTO_PATH + inning.getBatting_team().getTeamName4()+"\\\\"
						+ battingCardList.get(1).getPlayer().getPhoto()+ CricketUtil.PNG_EXTENSION + "\0", print_writers);
			}
			if(CricketFunctions.isImpactPlayer(matchAllData.getEventFile().getEvents(), inning.getInningNumber(), battingCardList.get(0).getPlayer().getPlayerId()).equalsIgnoreCase(CricketUtil.YES)) {
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
						+"$Partnership$PhotoGrp1$Select_Impact*FUNCTION*Omo*vis_con SET 1\0", print_writers);
			} else {
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
						+"$Partnership$PhotoGrp1$Select_Impact*FUNCTION*Omo*vis_con SET 0\0", print_writers);
			}
			if(CricketFunctions.isImpactPlayer(matchAllData.getEventFile().getEvents(), inning.getInningNumber(), battingCardList.get(1).getPlayer().getPlayerId()).equalsIgnoreCase(CricketUtil.YES)) {
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
						+"$Partnership$PhotoGrp2$Select_Impact*FUNCTION*Omo*vis_con SET 1\0", print_writers);
			} else {
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
						+"$Partnership$PhotoGrp2$Select_Impact*FUNCTION*Omo*vis_con SET 0\0", print_writers);
			}
			CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Partnership$ScoreGrp$fig_Runs"
					+ "*GEOM*TEXT SET " + inning.getPartnerships().get(inning.getPartnerships().size() - 1).getTotalRuns() + "*" + "\0", print_writers);
			CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Partnership$ScoreGrp$fig_Balls"
					+ "*GEOM*TEXT SET " + inning.getPartnerships().get(inning.getPartnerships().size() - 1).getTotalBalls()+" " + "\0", print_writers);
			
			if(battingCardList.get(0).getPlayer().getSurname() != null) {
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Partnership$1"
						+ "$Name_Grp1$txt_BatterFirstName*GEOM*TEXT SET " + battingCardList.get(0).getPlayer().getFirstname() + "\0", print_writers);
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Partnership$1"
						+ "$Name_Grp1$txt_BatterLastName*GEOM*TEXT SET " + battingCardList.get(0).getPlayer().getSurname() + "\0", print_writers);
			}else {
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Partnership$1"
						+ "$Name_Grp1$txt_BatterFirstName*GEOM*TEXT SET " + battingCardList.get(0).getPlayer().getFull_name() + "\0", print_writers);
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Partnership$1"
						+ "$Name_Grp1$txt_BatterLastName*GEOM*TEXT SET \0", print_writers);
			}
			if(battingCardList.get(1).getPlayer().getSurname() != null) {
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Partnership$1"
						+ "$Name_Grp2$txt_BatterFirstName*GEOM*TEXT SET " + battingCardList.get(1).getPlayer().getFirstname() + "\0", print_writers);
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Partnership$1"
						+ "$Name_Grp2$txt_BatterLastName*GEOM*TEXT SET " + battingCardList.get(1).getPlayer().getSurname() + "\0", print_writers);
			}else {
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Partnership$1"
						+ "$Name_Grp2$txt_BatterFirstName*GEOM*TEXT SET " + battingCardList.get(1).getPlayer().getFull_name() + "\0", print_writers);
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Partnership$1"
						+ "$Name_Grp2$txt_BatterLastName*GEOM*TEXT SET \0", print_writers);
			}
			
			CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Partnership$2"
					+ "$Contribution1$txt_Runs*GEOM*TEXT SET " + inning.getPartnerships().get(inning.getPartnerships().size() - 1).getFirstBatterRuns() + "\0", print_writers);
			CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$Main$AllGraphics$Side" + WhichSide + "$Partnership$2"
					+ "$Contribution1$txt_Ball*GEOM*TEXT SET " + inning.getPartnerships().get(inning.getPartnerships().size() - 1).getFirstBatterBalls() + "\0", print_writers);
			
			CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Partnership$2"
					+ "$Contribution2$txt_Runs*GEOM*TEXT SET " + inning.getPartnerships().get(inning.getPartnerships().size() - 1).getSecondBatterRuns() + "\0", print_writers);
			CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$Main$AllGraphics$Side" + WhichSide + "$Partnership$2"
					+ "$Contribution2$txt_Ball*GEOM*TEXT SET " + inning.getPartnerships().get(inning.getPartnerships().size() - 1).getSecondBatterBalls() + "\0", print_writers);
			break;
				...
				for(int i = 1; i <= 2 ; i++) {
					if(i == 1) {
						...
						if(matchAllData.getSetup().getHomeTeam().getTeamName4().contains("KHILADI XI") || matchAllData.getSetup().getHomeTeam().getTeamName4().contains("MASTER 11")) {
							...
							logo_name = matchAllData.getSetup().getHomeTeam().getTeamBadge();
						}
						...
						case Constants.NPL:
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$ExtraData$Side" + WhichSide + "$Select_DataType"
									+ "$2_Logo$Team1$img_Badges*TEXTURE*IMAGE SET " + Constants.NPL_LOGO_PATH + logo_name + "\0", print_writers);
							break;
						case Constants.ICC_U19_2023: 
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Teams$" + 
						...
						for(Player hs : matchAllData.getSetup().getHomeSquad()) {
							...
							if(!config.getBroadcaster().toUpperCase().equalsIgnoreCase(Constants.NPL)) {
								CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Teams$" + 
								...
								if(hs.getSurname() != null) {
									CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Teams$" + 
											containerName + i + "$" + rowId + "$txt_BatterFirstName*GEOM*TEXT SET " + hs.getFirstname() + "\0", print_writers);
									CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Teams$" + 
											containerName + i + "$" + rowId + "$txt_BatterLastName*GEOM*TEXT SET " + hs.getSurname() + "\0", print_writers);
								}else {
									CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Teams$" + 
											containerName + i + "$" + rowId + "$txt_BatterFirstName*GEOM*TEXT SET \0", print_writers);
									CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Teams$" + 
											containerName + i + "$" + rowId + "$txt_BatterLastName*GEOM*TEXT SET " + hs.getFirstname() + "\0", print_writers);
								}
							}
							...
							case Constants.NPL:
								CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Teams$Team1$" + 
										rowId + "$txt_Description*GEOM*TEXT SET " + hs.getRole().toUpperCase() + "\0", print_writers);
								break;
							case Constants.BENGAL_T20:
						...
						if(matchAllData.getSetup().getAwayTeam().getTeamName4().contains("KHILADI XI") || matchAllData.getSetup().getAwayTeam().getTeamName4().contains("MASTER 11")) {
							...
							logo_name = matchAllData.getSetup().getAwayTeam().getTeamBadge();
						}
						...
						case Constants.NPL:
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$ExtraData$Side" + WhichSide + "$Select_DataType"
									+ "$2_Logo$Team2$img_Badges*TEXTURE*IMAGE SET " + Constants.NPL_LOGO_PATH + logo_name + "\0", print_writers);
							break;
						case Constants.ICC_U19_2023: 
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Teams$" + 
						...
						for(Player as : matchAllData.getSetup().getAwaySquad()) {
							...
							if(!config.getBroadcaster().toUpperCase().equalsIgnoreCase(Constants.NPL)) {
								...
								if(as.getSurname() != null) {
									CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Teams$" + 
											containerName + i + "$" + rowId + "$txt_BatterFirstName*GEOM*TEXT SET " + as.getFirstname() + "\0", print_writers);
									CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Teams$" + 
											containerName + i + "$" + rowId + "$txt_BatterLastName*GEOM*TEXT SET " + as.getSurname() + "\0", print_writers);
								}else {
									CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Teams$" + 
											containerName + i + "$" + rowId + "$txt_BatterFirstName*GEOM*TEXT SET \0", print_writers);
									CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Teams$" + 
											containerName + i + "$" + rowId + "$txt_BatterLastName*GEOM*TEXT SET " + as.getFirstname() + "\0", print_writers);
								}
							}
							...
							case Constants.NPL:
								CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Teams$Team2$" + 
										rowId + "$txt_Description*GEOM*TEXT SET " + as.getRole().toUpperCase() + "\0", print_writers);
								break;
							case Constants.BENGAL_T20:
...
//					}
			...
			case Constants.NPL:
				...
				for(int i=1;i<=PlayingXI.size();i++) {
					...
					if(config.getPrimaryIpAddress().equalsIgnoreCase(Constants.LOCALHOST)) {
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$LineUp_Image" + containerName
								+ "$Photo_" + rowId + "$img_Photo*TEXTURE*IMAGE SET "+ Constants.NPL_LOCAL_PHOTO_PATH + team.getTeamName4() + "\\\\"
								+ PlayingXI.get(i-1).getPhoto() + CricketUtil.PNG_EXTENSION + "\0", print_writers);
					}else {
						CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$LineUp_Image" + containerName
								+ "$Photo_" + rowId + "$img_Photo*TEXTURE*IMAGE SET "+"\\\\"+config.getPrimaryIpAddress()+"\\"+Constants.NPL_PHOTO_PATH + team.getTeamName4() + "\\" 
								+ PlayingXI.get(i-1).getPhoto() + CricketUtil.PNG_EXTENSION + "\0", print_writers);
					}
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$LineUp_Image" + containerName
							+ "$Photo_" + rowId + "$Name$txt_PlayerName*GEOM*TEXT SET " + PlayingXI.get(i-1).getTicker_name() + "\0", print_writers);
...
//										+ rowId + containerName + "$StatsGrp$txt_Matches*GEOM*TEXT SET  \0", print_writers);
	...
	public String populatePartnershipListBody(int WhichSide, String whatToProcess, MatchAllData matchAllData, int WhichInning) {
		...
		case Constants.NPL:
			...
			if(inning.getPartnerships().size()>=10) {
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Partnership_List$Select_NumberOfRows"
...
//										row_size = (inning.getBattingCard().size() - 1);
						...
						if(impactData[1] != null) {
							if(inning.getBatting_team().getTeamId() == impactData[1].getTeamId()) {
								if(bc.getPlayerId() == impactData[1].getOutPlayerId()) {
									if(!inning.getBattingCard().stream().filter(btc -> btc.getPlayerId() == impactData[1].getInPlayerId()).findFirst().isPresent()) {
										impactPlayer = cricketService.getAllPlayer().get(impactData[1].getInPlayerId()-1);
										isImpactPlayerStillToBat = true;
									}
									if(bc.getStatus().equalsIgnoreCase(CricketUtil.STILL_TO_BAT) && isImpactPlayerStillToBat == false) {
//										row_size = (inning.getBattingCard().size() - 1);
				...
				if(CricketFunctions.isImpactPlayer(matchAllData.getEventFile().getEvents(), inning.getInningNumber(), ps.getFirstPlayer().getPlayerId()).equalsIgnoreCase(CricketUtil.YES)) {
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
							+"$Partnership_List$"+ rowId + containerName +"$ImpactGrp1$Select_Impact*FUNCTION*Omo*vis_con SET 1\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
							+"$Partnership_List$"+ rowId + containerName +"$txt_Name1*FUNCTION*Maxsize*WIDTH_X SET 350.0\0", print_writers);
				}else {
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
							+"$Partnership_List$"+ rowId +containerName+"$ImpactGrp1$Select_Impact*FUNCTION*Omo*vis_con SET 0\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
							+"$Partnership_List$"+ rowId +containerName+"$txt_Name1*FUNCTION*Maxsize*WIDTH_X SET 420.0\0", print_writers);
				}
				if(CricketFunctions.isImpactPlayer(matchAllData.getEventFile().getEvents(), inning.getInningNumber(), ps.getSecondPlayer().getPlayerId()).equalsIgnoreCase(CricketUtil.YES)) {
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
							+"$Partnership_List$"+ rowId + containerName +"$ImpactGrp2$Select_Impact*FUNCTION*Omo*vis_con SET 1\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
							+"$Partnership_List$"+ rowId + containerName +"$txt_Name2*FUNCTION*Maxsize*WIDTH_X SET 350.0\0", print_writers);
				}else {
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
							+"$Partnership_List$"+ rowId +containerName+"$ImpactGrp2$Select_Impact*FUNCTION*Omo*vis_con SET 0\0", print_writers);
					CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
							+"$Partnership_List$"+ rowId +containerName+"$txt_Name2*FUNCTION*Maxsize*WIDTH_X SET 420.0\0", print_writers);
				}
				if(impactData != null) {
					if(impactData[0] != null) {
						if(impactData[0].getOutPlayerId() == ps.getFirstPlayer().getPlayerId()) {
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
									+"$Partnership_List$"+ rowId + containerName +"$ImpactGrp1$Select_Impact*FUNCTION*Omo*vis_con SET 2\0", print_writers);
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
									+"$Partnership_List$"+ rowId + containerName +"$txt_Name1*FUNCTION*Maxsize*WIDTH_X SET 350.0\0", print_writers);
						}
						if(impactData[0].getOutPlayerId() == ps.getSecondPlayer().getPlayerId()) {
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
									+"$Partnership_List$"+ rowId + containerName +"$ImpactGrp2$Select_Impact*FUNCTION*Omo*vis_con SET 2\0", print_writers);
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
									+"$Partnership_List$"+ rowId + containerName +"$txt_Name2*FUNCTION*Maxsize*WIDTH_X SET 350.0\0", print_writers);
						}
					}
					if(impactData[1] != null) {
						if(impactData[1].getOutPlayerId() == ps.getFirstPlayer().getPlayerId()) {
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
									+"$Partnership_List$"+ rowId + containerName +"$ImpactGrp1$Select_Impact*FUNCTION*Omo*vis_con SET 2\0", print_writers);
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
									+"$Partnership_List$"+ rowId + containerName +"$txt_Name1*FUNCTION*Maxsize*WIDTH_X SET 350.0\0", print_writers);
						}
						if(impactData[1].getOutPlayerId() == ps.getSecondPlayer().getPlayerId()) {
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
									+"$Partnership_List$"+ rowId + containerName +"$ImpactGrp2$Select_Impact*FUNCTION*Omo*vis_con SET 2\0", print_writers);
							CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
									+"$Partnership_List$"+ rowId + containerName +"$txt_Name2*FUNCTION*Maxsize*WIDTH_X SET 350.0\0", print_writers);
				...
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Partnership_List$"
						+ rowId + "$Select_Row_Type" + containerName +"$txt_Name1*GEOM*TEXT SET " + Left_Batsman + "\0", print_writers);
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Partnership_List$"
						+ rowId + "$Select_Row_Type" + containerName +"$txt_Name2*GEOM*TEXT SET " + Right_Batsman + "\0", print_writers);
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Partnership_List$"
						+ rowId + "$Select_Row_Type" + containerName +"$txt_Runs*GEOM*TEXT SET " + ps.getTotalRuns() + "\0", print_writers);
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Partnership_List$"
						+ rowId + "$Select_Row_Type" + containerName +"$txt_Balls*GEOM*TEXT SET " + ps.getTotalBalls() + "\0", print_writers);
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Partnership_List$"
			...
			if(inning.getPartnerships().size() >= 10) {
				...
				CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Partnership_List$" 
						+ rowId + "$Select_Row_Type$Title$txt_Title*GEOM*TEXT SET " + "" + "\0", print_writers);
			}else {
				for (BattingCard bc : inning.getBattingCard()) {
					if(rowId < inning.getBattingCard().size()) {
						if(rowId == inning.getPartnerships().size()) {
							...
							if(inning.getTotalOvers() == matchAllData.getSetup().getMaxOvers() 
									|| inning.getTotalWickets() >= 10 ) {
								CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Partnership_List$" 
										+ rowId + "$Select_Row_Type$Title$txt_Title*GEOM*TEXT SET " + "DID NOT BAT" + "\0", print_writers);
							}
								...
								if(inning.getInningStatus().equalsIgnoreCase(CricketUtil.PAUSE)) {
									...
									if(inning.getTotalOvers() == Integer.valueOf(matchAllData.getSetup().getTargetOvers()) 
											|| inning.getTotalWickets() >= 10) {
										CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Partnership_List$" 
												+ rowId + "$Select_Row_Type$Title$txt_Title*GEOM*TEXT SET " + "DID NOT BAT" + "\0", print_writers);
										...
										CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Partnership_List$" 
												+ rowId + "$Select_Row_Type$Title$txt_Title*GEOM*TEXT SET " + "STILL TO BAT" + "\0", print_writers);
									}
								}
							}
							else if(CricketFunctions.getRequiredRuns(matchAllData) <= 0 || CricketFunctions.getRequiredBalls(matchAllData) <= 0 ||
							...
							if(bc.getPlayer().getSurname() != null) {
								CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Partnership_List$" 
										+ rowId + "$Select_Row_Type$Still_To_Bat$txt_FirstName*GEOM*TEXT SET " + 
										bc.getPlayer().getFirstname() + "\0", print_writers);
								CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Partnership_List$" 
										+ rowId + "$Select_Row_Type$Still_To_Bat$txt_LastName*GEOM*TEXT SET " + 
										bc.getPlayer().getSurname() + "\0", print_writers);
							}else {
								CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Partnership_List$" 
										+ rowId + "$Select_Row_Type$Still_To_Bat$txt_FirstName*GEOM*TEXT SET " + 
										bc.getPlayer().getFull_name() + "\0", print_writers);
								CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Partnership_List$" 
										+ rowId + "$Select_Row_Type$Still_To_Bat$txt_LastName*GEOM*TEXT SET \0", print_writers);
							}
							if(CricketFunctions.isImpactPlayer(matchAllData.getEventFile().getEvents(), inning.getInningNumber(), bc.getPlayerId()).equalsIgnoreCase(CricketUtil.YES)) {
								CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
										+"$Partnership_List$"+ rowId  +"$Still_To_Bat$ImpactGrp$Select_Impact*FUNCTION*Omo*vis_con SET 1\0", print_writers);
								CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
										+"$Partnership_List$"+ rowId  +"$Still_To_Bat$Maxsize*FUNCTION*Maxsize*WIDTH_X SET 515.0\0", print_writers);
							}else {
								CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
										+"$Partnership_List$"+ rowId +"$Still_To_Bat$ImpactGrp$Select_Impact*FUNCTION*Omo*vis_con SET 0\0", print_writers);
								CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
										+"$Partnership_List$"+ rowId +"$Still_To_Bat$Maxsize*FUNCTION*Maxsize*WIDTH_X SET 585.0\0", print_writers);
							}
							if(impactData[0] != null) {
								if(inning.getBatting_team().getTeamId() == impactData[0].getTeamId()) {
									if(isImpactPlayerStillToBat && impactData[0].getOutPlayerId() == bc.getPlayerId()) {
										if(impactPlayer.getSurname() != null) {
											CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Partnership_List$" 
													+ rowId + "$Select_Row_Type$Still_To_Bat$txt_FirstName*GEOM*TEXT SET " + 
													impactPlayer.getFirstname() + "\0", print_writers);
											CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Partnership_List$" 
													+ rowId + "$Select_Row_Type$Still_To_Bat$txt_LastName*GEOM*TEXT SET " + 
													impactPlayer.getSurname() + "\0", print_writers);
										}else {
											CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Partnership_List$" 
													+ rowId + "$Select_Row_Type$Still_To_Bat$txt_FirstName*GEOM*TEXT SET " + 
													impactPlayer.getFull_name() + "\0", print_writers);
											CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Partnership_List$" 
													+ rowId + "$Select_Row_Type$Still_To_Bat$txt_LastName*GEOM*TEXT SET \0", print_writers);
										}
										CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$AllGraphics$Side" + WhichSide 
							...
							if(rowId == inning.getPartnerships().size()) {
								...
								if(config.getBroadcaster().equalsIgnoreCase(Constants.BENGAL_T20)) {
									if(CricketFunctions.checkImpactPlayer(matchAllData.getEventFile().getEvents(), inning.getInningNumber(),
											bc.getPlayerId()).equalsIgnoreCase(CricketUtil.YES)) {
										CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Partnership_List$"
												+ containerName_2 + "$" + rowId + "$Select_Row_Type$Still_To_Bat$Select_Impact*FUNCTION*Omo*vis_con SET 1 \0", print_writers);
									}
									else if(CricketFunctions.checkImpactPlayerBowler(matchAllData.getEventFile().getEvents(), inning.getInningNumber(), 
											bc.getPlayerId()).equalsIgnoreCase(CricketUtil.YES)) {
										CricketFunctions.DoadWriteCommandToAllViz("-1 RENDERER*BACK_LAYER*TREE*$gfx_Full_Frame$AllGraphics$Side" + WhichSide + "$Partnership_List$"
